...
class FrontendRegressionTests(unittest.TestCase):
    ...
    def test_explore_stage_shell(self):
        ...
        self.assertIn("v=20260817-glmnew", html)
        ...
        self.assertIn("/api/author/jobs", app)
        self.assertIn("function fetchAuthorCard(", app)
        self.assertIn("function pickSeedCard(", app)
        self.assertIn("function waitForNewCard(", app)
        self.assertIn("function resumeWaitingExplore(", app)
        ...
        self.assertIn("AUTHOR_WAIT_MS = 125000", app)
        self.assertIn("AUTHOR_JOB_KEY", app)
        self.assertIn('id="authorWaitWrap"', html)
        self.assertIn("点开始玩，马上就能开始", html)
        self.assertIn("大约要 2 分钟", html)
        self.assertIn("切到后台也没关系", html)
        ...
        self.assertIn("warmAuthorJob", start)
        ...
        self.assertIn("parkCurrentWait", choose)
        ...
        self.assertNotIn("unusedSeedCard", start_ex)
        self.assertNotIn("pickSeedCard", start_ex)
        wait = app[app.find("async function waitForNewCard"):app.find("function friendlyAuthorError")]
        self.assertIn('data.status === "failed"', app)
        self.assertIn("GLM-5.3", wait)
        self.assertNotIn("return ready || pickSeedCard", wait)
