...
class FrontendRegressionTests(unittest.TestCase):
    ...
    def test_explore_stage_shell(self):
        ...
        self.assertIn(".app.layout-explore.talk-open .voice-hint { display: block;", css)
        ...
        self.assertIn("v=20260823-voice", html)
        ...
        self.assertNotIn(".app.layout-explore.talk-open .voice-hint { display: none; }", css)
